...
const passwordCopy = {
  ...
  text: "Pakeitus slaptazodi visos aktyvios sesijos bus atjungtos.",
  currentPassword: "Dabartinis slaptazodis",
  newPassword: "Naujas slaptazodis",
  confirmPassword: "Pakartok nauja slaptazodi",
  submit: "Pakeisti slaptazodi",
  loading: "Keiciama...",
  required: "Uzpildyk visus slaptazodzio laukus.",
  length: "Naujas slaptazodis turi buti 6-128 simboliu.",
  mismatch: "Nauji slaptazodziai nesutampa.",
  success: "Slaptazodis pakeistas. Prisijunk is naujo.",
  fail: "Slaptazodzio pakeisti nepavyko.",
};
