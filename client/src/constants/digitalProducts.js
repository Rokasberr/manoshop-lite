...
export const digitalProducts = [
  {
    ...
    description:
      "Praktinis biudžeto valdymo paketas, padedantis sekti pajamas, išlaidas, taupymo tikslus ir mėnesio balansą vienoje aiškioje sistemoje.",
    category: "Finansai",
    priceLabel: "€9",
    priceCents: 900,
    pdfFileName: "personal-budget-system.pdf",
    excelFileName: "personal-budget-system.xlsx",
    badges: ["Su formulėmis", "Automatinis dashboard"],
    includedItems: [
    ...
    pdfFeatures: ["Naudojimo eiga", "Praktinės lentelės", "Realistiškas pavyzdys", "Mėnesio checklist"],
    dashboardMetrics: [
      "Pajamos",
      "Išlaidos",
      "Mėnesio balansas",
