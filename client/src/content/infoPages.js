...
"Rašyk mums el. paštu hello@stilloak-studio.com. Jei klausimas susijęs su konkrečiu pirkimu, pridėk užsakymo numerį ir trumpą situacijos aprašymą.",
  ...
  webServicesPrivacy: {
    ...
    eyebrow: "Stilloak Web · testinė versija",
    summary: "Paaiškiname, kokie duomenys reikalingi svetainės projekto užklausai, pasiūlymui, mokėjimui ir projekto perdavimui. Kol veikla neįregistruota, ši informacija yra parengiamasis juodraštis.",
    lastUpdated: "2026 m. rugpjūčio 29 d.",
    ...
    sections: [
      ...
      { heading: "Saugojimas ir teisės", paragraphs: ["Užklausos ir projekto duomenys saugomi tik tiek, kiek reikia projektui, ginčų prevencijai ir taikomoms prievolėms. Galite prašyti susipažinti, ištaisyti, apriboti ar, kai taikoma, ištrinti duomenis, parašę hello@stilloak-studio.com."] },
    ],
    cta: { label: "Grįžti į pradžią", to: "/" },
  },
  webServicesTerms: {
    ...
    eyebrow: "Stilloak Web · testinė versija",
    summary: "Šios sąlygos aprašo pasiūlymo, avanso, darbų, pakeitimų ir perdavimo procesą. Jos dar neaktyvios kaip galutinės verslo sąlygos, kol neįregistruota veikla ir neįvesti paslaugų teikėjo rekvizitai.",
    lastUpdated: "2026 m. rugpjūčio 29 d.",
    highlights: ["Kaina ir apimtis nustatomos individualiame pasiūlyme", "Darbai pradedami gavus avansą", "Papildomi darbai derinami atskirai"],
    sections: [
      { heading: "Pasiūlymas ir mokėjimai", paragraphs: ["Konkreti darbų apimtis, kaina, avanso dydis, terminas ir pasiūlymo galiojimas pateikiami privačiame pasiūlyme. Likusi suma mokama pagal projekte nurodytą etapą. Testavimo metu mokėjimai ir dokumentai neturi būti laikomi tikromis sąskaitomis ar galutine teisine sutartimi."] },
      ...
      { heading: "Ginčai", paragraphs: ["Pirmiausia prašome kreiptis hello@stilloak-studio.com. Vartotojo prašymas nagrinėjamas teisės aktuose nustatyta tvarka; galutinėje versijoje bus įrašyti veiklos vykdytojo rekvizitai ir kompetentinga ginčų institucija."] },
    ],
  ...
  webServicesRefunds: {
    ...
    sections: [
      ...
      { heading: "Kaip pateikti prašymą", paragraphs: ["Parašykite hello@stilloak-studio.com, nurodykite užsakymo numerį ir prašymą. Atsakysime raštu ir pateiksime sprendimo bei, jei taikoma, grąžinamos sumos apskaičiavimą."] },
    ],
