...
`VITE_GOOGLE_ADS_ID` (pvz. `AW-...`) ir `VITE_GOOGLE_ADS_LEAD_LABEL` naudojami Google Ads užklausos konversijai. Google Ads ir Meta žymos įkeliamos tik gavus rinkodaros sutikimą; GA4 – tik gavus analitikos sutikimą. Google Consent Mode v2 pagal nutylėjimą nustato visas nebūtinas saugyklas į `denied` ir atnaujina pasirinkimą po sutikimo.
...
- `VITE_GOOGLE_ADS_ID` — Google Ads žymos identifikatorius (`AW-...`)
- `VITE_GOOGLE_ADS_LEAD_LABEL` — Google Ads užklausos konversijos label
