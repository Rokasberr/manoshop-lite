...
const webServiceRequestSchema = new mongoose.Schema(
  {
    ...
    billingName: { type: String, trim: true, maxlength: 200, default: "" },
    companyCode: { type: String, trim: true, maxlength: 50, default: "" },
    vatCode: { type: String, trim: true, maxlength: 50, default: "" },
    billingAddress: { type: String, trim: true, maxlength: 300, default: "" },
    ...
    proposalAcceptedIp: { type: String, trim: true, maxlength: 100, default: "" },
    ...
    carePlan: { type: String, trim: true, maxlength: 500, default: "" },
    handoverItems: { type: [String], default: [] },
